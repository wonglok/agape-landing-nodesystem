        ...
        <Suspense fallback={null}>
          <group position={[0, 0, 0]} rotation={[Math.PI * 0, 0, 0]}>
            <Load
              ...
              color='#ffffff'
              axis={'z'}
              url={`/vat/particles/particle_works.glb`}
              geoQuery={(glb) => {
...
function Load({
  ...
  let offsets = useLoader(EXRLoader, `/vat/particles/offsets.exr`)
  let normals = useLoader(EXRLoader, `/vat/particles/normals.exr`)
