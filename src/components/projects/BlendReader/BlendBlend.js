...
let BlenderBlend = (function () {
  ...
  let DnaStruct = (BlenderBlend.DnaStruct = (function () {
  ...
  let FileBlock = (BlenderBlend.FileBlock = (function () {
  ...
  let Dna1Body = (BlenderBlend.Dna1Body = (function () {
    ...
    Dna1Body.prototype._read = function () {
      ...
      if (!(KaitaiStream.byteArrayCompare(this.id, [83, 68, 78, 65]) == 0)) {
        throw new KaitaiStream.ValidationNotEqualError(
          ...
          this.id,
          this._io,
          '/types/dna1_body/seq/0'
        )
      }
      this.nameMagic = this._io.readBytes(4)
      if (
        !(KaitaiStream.byteArrayCompare(this.nameMagic, [78, 65, 77, 69]) == 0)
      ) {
        throw new KaitaiStream.ValidationNotEqualError(
          [78, 65, 77, 69],
          this.nameMagic,
          this._io,
          '/types/dna1_body/seq/1'
        )
      }
      ...
      if (
        !(KaitaiStream.byteArrayCompare(this.typeMagic, [84, 89, 80, 69]) == 0)
      ) {
        throw new KaitaiStream.ValidationNotEqualError(
          [84, 89, 80, 69],
          this.typeMagic,
          this._io,
          '/types/dna1_body/seq/5'
        )
      }
      ...
      if (
        !(KaitaiStream.byteArrayCompare(this.tlenMagic, [84, 76, 69, 78]) == 0)
      ) {
        throw new KaitaiStream.ValidationNotEqualError(
          [84, 76, 69, 78],
          this.tlenMagic,
          this._io,
          '/types/dna1_body/seq/9'
        )
      }
      this.lengths = []
      for (let i = 0; i < this.numTypes; i++) {
      ...
      if (
        !(KaitaiStream.byteArrayCompare(this.strcMagic, [83, 84, 82, 67]) == 0)
      ) {
        throw new KaitaiStream.ValidationNotEqualError(
          [83, 84, 82, 67],
          this.strcMagic,
      ...
      this.structs = []
      for (let i = 0; i < this.numStructs; i++) {
  ...
  let Header = (BlenderBlend.Header = (function () {
  ...
  let DnaField = (BlenderBlend.DnaField = (function () {
